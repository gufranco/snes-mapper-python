...
**6** layouts · **289** header combinations replayed across **2,781** retail cartridges, **0** disagreements · **8** transfer channels · **568** tests · **100%** statement and branch coverage · no dependencies
